...
const TIPS = [
	...
	"Zoo Code can {highlight}configure itself{/highlight} if you ask it",
	"Ask Zoo Code to {highlight}add Supabase MCP globally{/highlight}",
	"Ask Zoo Code to {highlight}create a review agent for this project{/highlight}",
	"Ask Zoo Code to {highlight}add a plugin for desktop alerts{/highlight}",
	"Ask Zoo Code to {highlight}set Claude Sonnet as my default model{/highlight}",
	"Ask Zoo Code to {highlight}make my review agent read-only{/highlight}",
	"Ask Zoo Code to {highlight}require approval before git push{/highlight}",
	"Ask Zoo Code to {highlight}turn off auto-formatting{/highlight}",
	"Ask Zoo Code to {highlight}block access to .env files{/highlight}",
	"Ask Zoo Code to {highlight}turn off the F2 shortcut{/highlight}",
	"Ask Zoo Code to {highlight}match my terminal theme{/highlight}",
	"Ask Zoo Code to {highlight}disable sharing for all sessions{/highlight}",
	"Ask Zoo Code to {highlight}add rules from docs/ai-rules.md{/highlight}",
	"Ask Zoo Code to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
	"Ask Zoo Code to {highlight}save this workflow as a /command{/highlight}",
	"Zoo Code auto-handles OAuth for remote MCP servers requiring auth",
	"Zoo Code auto-formats files using prettier, gofmt, ruff, and more",
	"Zoo Code uses LSP servers for intelligent code analysis",
	...
	"Run {highlight}zoo serve{/highlight} for headless API access to Zoo Code",
	...
	"Run {highlight}zoo auth list{/highlight} to see all configured providers",
