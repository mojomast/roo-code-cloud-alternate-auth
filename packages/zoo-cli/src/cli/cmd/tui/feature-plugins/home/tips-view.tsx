...
const TIPS = [
	...
	"Run {highlight}zoo debug config{/highlight} to troubleshoot configuration",
	...
	"Run {highlight}docker run -it --rm ghcr.io/zoo-code-org/zoo-code{/highlight} for containerized use",
