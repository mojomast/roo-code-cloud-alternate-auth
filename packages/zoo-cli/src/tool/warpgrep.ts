...
const Parameters = Schema.Struct({
	query: Schema.String.annotate({
		description:
			"Search query describing what code you are looking for. Be specific and descriptive for best results.", // kilocode_change
	}),
})
						...
						if (isAuthOrRateLimit) {
							yield* Effect.promise(() =>
								Bus.publish(TuiEvent.ToastShow, {
									...
									message:
										"Free period has ended. Set MORPH_API_KEY to continue. Get your key at morphllm.com",
									variant: "error",
									duration: 10000,
								}).catch(() => {}),
							)
